 ...
 * ActDec3
 *
 * @ORM\Table(name="act_dec3", indexes={@ORM\Index(name="NOM", columns={"NOM"}), @ORM\Index(name="IDNIM", columns={"IDNIM"}), @ORM\Index(name="ORI", columns={"ORI"}), @ORM\Index(name="C_NOM", columns={"C_NOM"}), @ORM\Index(name="COM_DEP", columns={"COMMUNE", "DEPART"}), @ORM\Index(name="P_NOM", columns={"P_NOM"}), @ORM\Index(name="LADATE", columns={"LADATE"}), @ORM\Index(name="M_NOM", columns={"M_NOM"})})
 * @ORM\Entity
 */
class ActDec3
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="TYPACT", type="string", length=1, nullable=true, options={"default"="D"})
     */
    private $typact = 'D';
