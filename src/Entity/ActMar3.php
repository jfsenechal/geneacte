...
class ActMar3
{
    ...
    #[ORM\Column(name: 'TYPACT', type: Types::STRING, length: 1, nullable: true, options: ['default' => 'M'])]
    public string $typact = 'M';
    ...
    #[ORM\Column(name: 'ORI', type: Types::STRING, length: 140, nullable: true)]
